...
export default function ThemeToggle() {
  ...
  return (
    ...
    >
      <span
        className={`absolute top-1 left-1 w-5 h-5 rounded-full bg-white dark:bg-primary-600 shadow-md transform transition-transform duration-300 flex items-center justify-center ${
